...
func (e *OpenAICompatExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	// Preserve the legacy bridge for non-Responses clients. Responses clients
	// already declare their executable capabilities through additional_tools.
	if execCtx.SourceFormat != sdktranslator.FormatOpenAIResponse {
